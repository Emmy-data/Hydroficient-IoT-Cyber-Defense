...
try:
    MQTT_CALLBACK_API_VERSION = mqtt.CallbackAPIVersion.VERSION_2
except AttributeError:
    MQTT_CALLBACK_API_VERSION = None
...
def run_capture(count):
    ...
    client = mqtt.Client(
        callback_api_version=MQTT_CALLBACK_API_VERSION,
        client_id="replay-attacker-capture"
    ) if MQTT_CALLBACK_API_VERSION else mqtt.Client(client_id="replay-attacker-capture")
...
def run_replay():
    ...
    ) if MQTT_CALLBACK_API_VERSION else mqtt.Client(client_id="replay-attacker")
...
def run_replay_delayed(delay):
    ...
    client = mqtt.Client(
        callback_api_version=MQTT_CALLBACK_API_VERSION,
        client_id="replay-attacker-delayed"
    ) if MQTT_CALLBACK_API_VERSION else mqtt.Client(client_id="replay-attacker-delayed")
...
def run_replay_modified():
    ...
    client = mqtt.Client(
        callback_api_version=MQTT_CALLBACK_API_VERSION,
        client_id="replay-attacker-modified"
    ) if MQTT_CALLBACK_API_VERSION else mqtt.Client(client_id="replay-attacker-modified")
