...
# ============================================
# mTLS CONFIGURATION - ADD THIS FOR TLS
# ============================================
TLS_CONFIG = {
...
def generate_sensor_data(zone: dict) -> dict:
    ...
    return {
        "device_id": f"grandmarina-sensor-{zone['device_id']}",
        "ts": int(time.time()),
        "zone": zone["zone_id"],
...
def main():
    ...
    client.tls_set(
        ...
        certfile=TLS_CONFIG["client_cert"],       # For mTLS   
        keyfile=TLS_CONFIG["client_key"],          # For mTLS
